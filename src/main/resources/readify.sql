...
(
    ...
    stato        ENUM ('in_attesa', 'pagato', 'in_elaborazione', 'spedito', 'consegnato', 'annullato', 'rimborsato') DEFAULT 'in_attesa',
    totale       DECIMAL(10, 2),
...
INSERT INTO Utente (email, password_cifrata, nome, cognome, ruolo, telefono)
VALUES ('admin@readify.it', SHA1('admin123'), 'Admin', 'Sistema', 'admin', '1234567890'),
...
INSERT INTO Indirizzo (id_utente, via, citta, cap, provincia, paese)
VALUES (2, 'Via Roma 123', 'Milano', '20121', 'MI', 'Italia'),
       (3, 'Corso Italia 45', 'Torino', '10121', 'TO', 'Italia');

INSERT INTO Categoria (nome_categoria, icona)
VALUES ('Narrativa', 'fa-book'),
...
INSERT INTO Libro (titolo, autore, prezzo, isbn, descrizione, disponibilita, copertina, vendite_totalis)
VALUES ('Il Signore degli Anelli', 'J.R.R. Tolkien', 25.90, '9788845205899', 'Un classico della letteratura fantasy',
        50, 'signore_anelli.jpg', 120),
       ('Fisica 1', 'James S. Walker', 45.50, '9788808061548', 'Manuale di fisica per l\'università', 30, 'fisica1.jpg',
        85),
       ('Il Piccolo Principe', 'Antoine de Saint-Exupéry', 12.90, '9788845205905', 'Una favola per bambini e adulti',
        75, 'piccolo_principe.jpg', 200),
       ('1984', 'George Orwell', 14.90, '9788804668237', 'Un classico della letteratura distopica', 40, '1984.jpg',
        150),
       ('La ragazza del treno', 'Paula Hawkins', 9.90, '9788804668244', 'Un thriller psicologico avvincente', 25,
        'ragazza_treno.jpg', 95);

INSERT INTO LibroCategoria (id_libro, id_categoria)
VALUES (1, 1),
       (1, 5), -- Il Signore degli Anelli: Narrativa, Fantasy
       (2, 2),
       (2, 3), -- Fisica 1: Scolastica, Scientifici
       (3, 1),
       (3, 4), -- Il Piccolo Principe: Narrativa, Bambini
       (4, 1),
       (4, 6), -- 1984: Narrativa, Gialli
       (5, 1),
       (5, 6); -- La ragazza del treno: Narrativa, Gialli

INSERT INTO Ordine (id_utente, id_indirizzo, data_ordine, stato, totale)
VALUES (2, 1, '2025-06-15 14:30:00', 'consegnato', 70.80),
       (3, 2, '2025-07-01 10:15:00', 'spedito', 60.40);

INSERT INTO Contiene (id_ordine, id_libro, quantita, prezzo_unitario)
VALUES (1, 1, 1, 25.90),
       (1, 3, 2, 12.90),
       (2, 2, 1, 45.50),
       (2, 5, 1, 9.90);

INSERT INTO Recensione (id_utente, id_libro, voto, commento)
VALUES (2, 1, 5, 'Assolutamente fantastico! Un capolavoro senza tempo.'),
